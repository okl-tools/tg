...
SECTION="utils"
PRIORITY="optional"
DEPENDS="libtesseract5, liblept5, qt6-base-dev, tesseract-ocr, libxcb1, libx11-xcb1, libxcb-xfixes0, libxcb-shape0, libxcb-shm0, libxcb-randr0, libxcb-image0, libxcb-keysyms1, libxcb-sync1, libxcb-xinerama0, libxcb-xkb1"
